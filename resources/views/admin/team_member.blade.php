                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                      	<button type="button" onclick="location.href = '{{{URL::route('admin_team_member_add')}}}';" class="btn btn-default">ADD NEW</button>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
		...
		<script>
			...
			$(document).ready(function() {
		        $('#datatable').DataTable({
		            ...
		            serverSide: true,
		            ajax: {
						url: '{!! route("admin_team_member_data") !!}',
						type: "POST"
			        },
		            columns: [
						...
						{ data: 'technology_known', name: 'technology_known' },
